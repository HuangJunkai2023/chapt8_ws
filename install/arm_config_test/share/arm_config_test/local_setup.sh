...
: ${AMENT_CURRENT_PREFIX:="/home/huang/chapt8_ws/install/arm_config_test"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/arm_config_test/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/arm_config_test/environment/path.sh"
